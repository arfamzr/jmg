...
class StateListView(ListView):
    template_name = 'account/state_admin/state/list.html'
    model = User
    paginate_by = 8
    ordering = ['-id']
...
class StateRegistrationView(FormView):
    ...
    template_name = 'account/state_admin/state/registration.html'
...
def state_toggle_active(request, pk):
    ...
    return render(request, 'account/state_admin/state/toggle_active.html', context)


# jmg state update state
class StateStateUpdateView(UpdateView):
    model = Profile
    form_class = StateForm
    template_name = 'account/state_admin/state/state_update.html'
    success_url = reverse_lazy('account:state_admin:state_list')
