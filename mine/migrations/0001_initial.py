# Generated by Django 3.1.2 on 2020-10-30 07:44
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Mine',
            fields=[
                ('lease_holder', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='mine.leaseholder', verbose_name='lease_holder')),
                ('address1', models.CharField(max_length=255, verbose_name='alamat')),
                ('address2', models.CharField(blank=True, max_length=255, verbose_name='alamat (line 2)')),
                ('address3', models.CharField(blank=True, max_length=255, verbose_name='alamat (line 3)')),
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('operators', models.ManyToManyField(blank=True, related_name='mines', to='mine.Operator', verbose_name='operators')),
            ],
            options={
