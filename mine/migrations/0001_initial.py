    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mine', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='miners', to='mine.mine', verbose_name='kuari')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('mine', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='miner_data', to='mine.mine', verbose_name='lombong')),
