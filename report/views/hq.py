...
from ..forms.hq import GraphForm, MineProductionGraphForm, MineWorkerGraphForm, MineReportForm, QuarryReportForm
...
def mine_report(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            main_statistic_list = main_statistic_list.order_by('data__state')
